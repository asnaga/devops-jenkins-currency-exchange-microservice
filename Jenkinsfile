pipeline {
  ...
  post {
       always {
         ...
         mail bcc: '', body: 'TEST Sending SUCCESS email from jenkins', cc: 'saurav.kumar@arisglobal.com', from: '', replyTo: '', subject: 'SUCCESS BUILDING PROJECT $env.JOB_NAME', to: 'rohith.b@arisglobal.com'
       }
       success {
       ...
       failure {
         ...
         mail bcc: '', body: 'TEST Sending FAILURE email from jenkins', cc: 'saurav.kumar@arisglobal.com', from: '', replyTo: '', subject: 'ERROR BUILDING PROJECT $env.JOB_NAME', to: 'rohith.b@arisglobal.com'
       }
     }
}
