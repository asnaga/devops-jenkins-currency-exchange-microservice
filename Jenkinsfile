pipeline {
  ...
  post {
       ...
       success {
         ...
         mail bcc: '', body: 'TEST Sending SUCCESS email from jenkins', cc: '', from: 'rohith.b@arisglobal.com', replyTo: '', subject: 'SUCCESS BUILDING PROJECT $PROJECT_NAME $env.JOB_NAME', to: 'rohith.b@arisglobal.com'
       }
       failure {
